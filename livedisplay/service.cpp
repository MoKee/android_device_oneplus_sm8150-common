...
#define LOG_TAG "vendor.mokee.livedisplay@2.1-service.oneplus_msmnile"
...
using ::vendor::mokee::livedisplay::V2_1::IDisplayModes;
...
using ::vendor::mokee::livedisplay::V2_1::implementation::DisplayModes;
